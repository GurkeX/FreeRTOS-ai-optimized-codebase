...
- Rpi pico w (controller running the code)
- pico probe debugging setup
- FreeRtos as framework

in this session,

**Note:** Make sure to first take a peek into the overview files of the other defined building blocks so we can maintain consistency and identify integration points.
