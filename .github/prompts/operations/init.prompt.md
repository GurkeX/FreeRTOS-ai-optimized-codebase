...
Create a `copilot-instructions.md` file under `.github` (or similar global rules file) following this structure:
...
11. **MCP Server Instructions** (if applicable)
    - Best practices for using Context 7 and Serena mcp for this codebase
    - Libraries for context 7 mcp
...
1. **Analyze the codebase thoroughly:**
    - **Optional: If the Serena MCP Server is available, initialize and use it to assist with codebase analysis**
    ...
    - Look for exitsting AGENTS.md or similar documentation
...
2. **After I answer, research best practices:**
    - **Optional: If the Serena MCP Server is available, initialize and use it to assist with research**
...
Create the copilot-instructions.md with:
