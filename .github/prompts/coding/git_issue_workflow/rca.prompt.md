...
Investigate GitHub issue ${input:text:github-issue-id} from this repository, identify the root cause, and document findings for future implementation.
...
Save analysis as: `resources/rca/issue-$github-issue-id.md`
