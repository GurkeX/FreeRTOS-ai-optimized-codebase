...
- Read through [project timeline](../../../../.agents/reference/piv-loop-iterations/project-timeline.md) to understand current phase and recent changes
- Review the [README](../../../../README.md) for overall project goals and architecture overview
