...
For this, follow ALL instructions in [priming.prompt.md](../../workflows/core-piv-loop/1-prime.prompt.md) but keep the last part "## Output Report" to your own thoughts **not** outputing to the user.
